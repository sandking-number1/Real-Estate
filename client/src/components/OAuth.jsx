  ...
  return (
    <div className="flex gap-6">
      <button
        ...
        className="flex items-center justify-center gap-4 p-3 border border-gray-300 rounded-full"
      >
        <img
          ...
          height={24}
        />
        <p className="hidden text-slate-500 xl:block">Login with Google</p>
      </button>
      <button className="flex items-center justify-center gap-4 p-3 border border-gray-300 rounded-full">
        <img
          ...
          height={24}
        />
        <p className="hidden text-slate-500 xl:block">Login with Facebook</p>
      </button>
    </div>
  )
}
